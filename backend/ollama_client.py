...
Exemples :
- Sujet: "Nouveau traité de paix au Moyen-Orient", Réponse: "traité paix" → {{"correct": true, "feedback": "Exact ! Tu as trouvé le sujet principal."}}
- Sujet: "Découverte d'une nouvelle espèce", Réponse: "un animal" → {{"correct": false, "feedback": "C'est un peu trop vague. Essaie d'être plus précis sur la découverte."}}
...
# Example JSON format
example = """{
  "title": "Nouvelle avancée technologique",
  "questions": [
    {
      "id": 1,
      "text": "Dans quel secteur une innovation majeure a-t-elle été annoncée récemment ?",
      "difficulty": 1
    },
    {
      "id": 2,
      "text": "Quelle entreprise ou organisation est à l'origine de cette découverte ?",
      "difficulty": 2
    },
    {
      "id": 3,
      "text": "Quel est le nom spécifique de cette technologie ou quel problème majeur résout-elle ?",
      "difficulty": 3
    }
  ],
  "hints": [
    "Cela concerne un domaine scientifique ou technologique",
    "Cette innovation pourrait changer notre quotidien",
    "Le sujet fait beaucoup parler dans les médias"
  ],
  "answer_keywords": ["technologie", "innovation", "découverte"],
  "full_answer": "Description complète de la réponse attendue"
}"""
